...
<li class="nav-item <?= menuOpen(['user', 'kategoribuku', 'buku', 'peminjam']); ?>">
            <a href="#" class="nav-link <?= menuActive(['user', 'kategoribuku', 'buku', 'peminjam']); ?>">    <i class="nav-icon fas fa-save"></i>
              <p>
                Data
...
<li class="nav-item <?= menuOpen(['perpustakaan', 'peminjaman', 'koleksi']); ?>">
            <a href="#" class="nav-link <?= menuActive(['perpustakaan', 'peminjaman', 'koleksi']); ?>">            <p>
                Perpustakaan
                <i class="right fas fa-angle-left"></i>
              </p>
            </a>
